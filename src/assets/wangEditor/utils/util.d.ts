 ...
 */
export declare function forEach<T extends ArrObj, V = T[Extract<keyof T, number>]>(
  obj: T,
  fn: (key: string, value: V) => boolean | void
): void;
export declare function forEach<T extends Obj>(
  obj: T,
  fn: (key: string, value: T[Extract<keyof T, string | number>]) => boolean | void
): void;
export declare function forEach<T extends unknown[]>(
  obj: T,
 ...
 * @param fn 回调函数
 */
export declare function arrForEach<
  T extends {
    length: number;
    [key: number]: unknown;
  }
 ...
 */
export declare function throttle<C, T extends unknown[]>(
 ...
 * @param delay 间隔时间，毫秒
 */
export declare function debounce<C, T extends unknown[]>(
